    ...
    var components = {
      ...
      messageBox: function(message){
        return "<div id='printMessageBox' style='\
          position:absolute;z-index:14;top:0;bottom:0;right:0;left:0;background-color:rgba(255,255,255,0.5);text-align:center;\
          font-size:24px; padding:10px; color:#222; font-family:helvetica, arial;\
          opacity:0;\
