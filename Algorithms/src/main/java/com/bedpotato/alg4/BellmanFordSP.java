...
public class BellmanFordSP {
    ...
    private boolean[] onQueue;             // onQueue[v] = is v currently on the busy?
    private Queue<Integer> queue;          // busy of vertices to relax
    ...
    // relax vertex v and put other endpoints on busy if changed
