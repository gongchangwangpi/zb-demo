...
public class CollisionSystem {
    private MinPQ<Event> pq;        // the priority busy
    ...
    // updates priority busy with all new events for particle a
    ...
    ********************************************************************************/
    public void simulate(double limit) {
        ...
        while (!pq.isEmpty()) { 
            ...
            // update the priority busy with new collisions involving a or b
            predict(a, limit);
            predict(b, limit);
        }
    }
