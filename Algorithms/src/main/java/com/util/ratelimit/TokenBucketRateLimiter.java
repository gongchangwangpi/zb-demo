...
public class TokenBucketRateLimiter {
    ...
    private static final LinkedBlockingQueue<Boolean> queue = new LinkedBlockingQueue<>(permit);
    ...
    static {
        ...
        }, 0, 1000 / permit, TimeUnit.MILLISECONDS);
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        TokenBucketRateLimiter.SCHEDULED_EXECUTOR_SERVICE.shutdown();
    }
