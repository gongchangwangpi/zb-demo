...
public class MyHttpServletRequestWrapper implements HttpServletRequest  {
    ...
    public MyHttpServletRequestWrapper() {
        //a trick for Groovy
        throw new IllegalArgumentException("Please use HttpServletRequestWrapper(HttpServletRequest request) constructor!");
    }

    private MyHttpServletRequestWrapper(HttpServletRequest request, byte[] contentData, HashMap<String, String[]> parameters) {
        req = request;
    ...
    public HttpServletRequest getRequest() {
        ...
        return new MyHttpServletRequestWrapper(req, contentData, parameters);
    }
